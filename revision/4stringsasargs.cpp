//strings jab bhi hum as an argument pass krte h , us time vo original me change nhi krta balki ek or string bnata h jo modify kr skte h , orignal remains intact 
#include <bits/stdc++.h>
using namespace std;
